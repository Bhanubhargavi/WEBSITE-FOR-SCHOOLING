...
<header>
      ...
      <h1 style="font-size:18px; font-weight:normal; text-align:center">Student S-Top</h1>
    </header>
...
<div class="gpa-calci" style="margin-top:30px"> 
  <a href = "cgpa.html">Wanted to calculate GPA or CGPA</a>
</div>
</div>
